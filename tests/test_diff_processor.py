...
class TestDiffProcessor:
    ...
    def test_process_files_filters_binary(self):
        ...
        files = [
            FileChange(
                filename="src/main.py", status="modified", additions=10, deletions=5, changes=15
            ),
            FileChange(filename="image.png", status="added", additions=0, deletions=0, changes=0),
            FileChange(
                filename="lib/util.js", status="modified", additions=8, deletions=3, changes=11
            ),
        ]
    ...
    def test_prioritize_files_security_first(self):
        ...
        files = [
            FileChange(
                filename="README.md", status="modified", additions=5, deletions=2, changes=7
            ),
            FileChange(
